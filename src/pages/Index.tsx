        ...
        <div className="mt-16 bg-petshop-gray p-8 rounded-2xl text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-8">
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <div className="w-16 h-16 mx-auto mb-4 bg-petshop-pink rounded-full flex items-center justify-center">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <div className="w-16 h-16 mx-auto mb-4 bg-petshop-yellow rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-petshop-purple" viewBox="0 0 20 20" fill="currentColor">
            ...
            <div className="bg-white p-6 rounded-xl shadow-sm">
              <div className="w-16 h-16 mx-auto mb-4 bg-petshop-green rounded-full flex items-center justify-center">
                <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-petshop-purple" viewBox="0 0 20 20" fill="currentColor">
